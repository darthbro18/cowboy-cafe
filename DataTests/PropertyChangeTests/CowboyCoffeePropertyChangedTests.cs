...
namespace CowboyCafe.DataTests.PropertyChangeTests
{
    public class CowboyCoffeePropertyChangedTests
    {
        ...
        //Test 2: Changing the "RoomForCream" property should invoke PropertyChanged for "RoomForCream"
        [Fact]
        ...
        //Test 9: Changing the "Size" property should invoke PropertyChanged for "Price"
        [Fact]
        ...
        //Test 10: Changing the "Size" property should invoke PropertyChanged for "Calories"
        [Fact]
